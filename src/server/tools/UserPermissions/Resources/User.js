...
var User = /** @class */ (function (_super) {
    ...
    User.prototype.authorizedToCreate = function () {
        return false;
    };
    User.prototype.collection = function () {
        return "lucent-" + _super.prototype.collection.call(this);
    };
    User.prototype.availableForNavigation = function () {
        return false;
    };
    ...
    User.prototype.beforeInsert = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, __assign(__assign({}, data), { password: data.password ? Bcrypt.hashSync(data.password) : data.password })];
            });
        });
    };
    return User;
